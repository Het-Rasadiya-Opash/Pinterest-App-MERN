  ...
  return (
    <div className="flex items-center justify-between flex-wrap gap-3">
      ...
      <button
        ...
        className="bg-red-600 text-white border-none rounded-3xl px-4 py-4 font-bold cursor-pointer transition-colors hover:bg-red-700 max-sm:px-4 max-sm:py-3 max-sm:text-sm"
      >
